...
namespace Arkitektum.Orden.Migrations
{
    ...
    [Migration("20180509131855_AddRoleNameToApplicationDatasetRelation")]
    partial class AddRoleNameToApplicationDatasetRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Arkitektum.Orden.Models.CommonApplication", b =>
                {
                    ...
                    b.HasIndex("SubmittedByOrganizationId");
            ...
            modelBuilder.Entity("Arkitektum.Orden.Models.Application", b =>
                {
                    ...
                    b.OwnsOne("Arkitektum.Orden.Models.Agreement", "Agreement", b1 =>
                        {
                            ...
                            b1.Property<string>("ResponsibleRole");

                            b1.Property<string>("TerminationClauses");

                            b1.ToTable("Application");

                            b1.HasOne("Arkitektum.Orden.Models.Application")
                                .WithOne("Agreement")
                                .HasForeignKey("Arkitektum.Orden.Models.Agreement", "ApplicationId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("Arkitektum.Orden.Models.ApplicationSuperUser", b =>
                {
                    ...
                    b.HasOne("Arkitektum.Orden.Models.SuperUser", "SuperUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Arkitektum.Orden.Models.CommonApplication", b =>
                {
                    b.HasOne("Arkitektum.Orden.Models.Organization", "SubmittedByOrganization")
                        .WithMany()
                        .HasForeignKey("SubmittedByOrganizationId");

                    b.HasOne("Arkitektum.Orden.Models.ApplicationUser", "SubmittedByUser")
                        .WithMany()
