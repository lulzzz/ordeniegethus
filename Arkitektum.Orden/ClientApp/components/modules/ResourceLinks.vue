<template>
    <div>
        <div class="list-group list-group-flush">
            ...
            <resource-link v-bind:api-url="apiUrl" v-bind:resource-link="resourceLink" v-bind:saved="true" v-for="resourceLink in savedResourceLinks" :key="resourceLink.id"></resource-link>
